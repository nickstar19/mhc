...
const Policy = () => {
  ...
  return (
    <>
      {/* <Helmet>
      <title>Policy - MH College World</title>
      <meta name="description" content="MH College World is website designed to ease the process of engineering and Medical admission"/>
      ...
      <div className="policy">
        ...
        <p>
          ...
          <br />
          When you browse our store, we also automatically receive your login
          token in order to keep you logged in.
        </p>
        ...
        <p>
          ...
          an order,return a purchase, we imply that you consent to our
          ...
          anytime, by contacting us at mhcollegeworld@gmail.com .
        </p>
