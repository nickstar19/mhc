...
const Terms = () => {
  ...
  return (
    <div className="policy">
      ...
      <h3>OVERVIEW</h3>
      <p>
        This website is operated by MH College World. Throughout the site, the
        terms “we”, “us” and “our” refer to MH College World. MH College world
      ...
      <p>
        ...
        shall MH College World, our directors, officers, employees, affiliates,
      ...
      <p>
        You agree to indemnify, defend and hold harmless MH College World and
      ...
      <h2>Refund Policy</h2>
      <p>
        Our Policy does not include any refunds, in case you have any queries do
        contact us on mhcollegeworld@gmail.com
      </p>
    </div>
  );
};
